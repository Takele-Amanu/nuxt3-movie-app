  ...
  <div class="flex flex-col md:flex-row">
    ...
    <div class="md:w-1/2 p-8 shadow-md">
      <p class="text-lg mb-2">
        123 Lideta Street<br />
        Addis Ababa, Ethiopia 12345
      </p>
      <p class="text-lg mb-2">
        Phone: (+251) 931292429<br />
        Email: takeleamanu9@gmail.com
      </p>
      <form>
        ...
        <button
           type="submit"
           class="bg-rose-500 hover:bg-rose-700 text-white
