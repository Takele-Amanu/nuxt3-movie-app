...
<template>
   <div class="grid sm:grid-cols-3 gap-7 justify-items-center 
   m-10">
      <!--Column 1: Image -->
      ...
      <!--Column 2: Ttile.Overview,revenue,Buy Button-->
      <div class="sm:col-span-2 mx-6">
        <h1 class="font-bold text-2xl mb-5">{{title }}</h1>
        <h3 class="font-semibold text-lg mb-5">Release Date: 
        {{ date }}</h3>
        ...
        <div class="mt-6">
          ...
          <button
            ...
            font-medium py-2 px-4 rondede m-5"
          >
            Buy Now
          </button>
        </div>
